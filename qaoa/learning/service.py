...
class LearningService:
    ...
    # QAOA: learn from QAOAObservation records
    ...
    def run_autonomous_cycle(
        ...
        *,
        ...
        from ..qaoa_learning.experience_tools import import_evolved_skills_to_store
        from ..qaoa_learning.ops_observability import (
        ...
        from ..qaoa_skills.skill_store import SkillStore
    ...
    def closed_loop_contract_report(self) -> dict[str, Any]:
        ...
        consumed = {
            ...
            "qaoateam_deeploop_enabled",
            "qaoateam_deeploop_max_iters",
            "qaoateam_deeploop_min_gap_delta",
            "qaoateam_deeploop_convergence_rounds",
            "qaoateam_deeploop_handoff_target",
            "qaoateam_deeploop_critical_degrade_enabled",
            "qaoateam_deeploop_auto_writeback_enabled",
            "qaoateam_deeploop_max_rollbacks",
            "qaoateam_deeploop_consistency_min",
        }
    ...
    def get_qaoateam_deeploop_config(self) -> dict[str, Any]:
        return {
            "enabled": bool(getattr(self.settings.closed_loop, "qaoateam_deeploop_enabled", True)),
            "max_iters": int(getattr(self.settings.closed_loop, "qaoateam_deeploop_max_iters", 7) or 7),
            "min_gap_delta": self._cl_float("qaoateam_deeploop_min_gap_delta", 0.05),
            "convergence_rounds": int(getattr(self.settings.closed_loop, "qaoateam_deeploop_convergence_rounds", 2) or 2),
            "handoff_target": self._cl_float("qaoateam_deeploop_handoff_target", 0.85),
            "critical_degrade_enabled": bool(
                getattr(self.settings.closed_loop, "qaoateam_deeploop_critical_degrade_enabled", True)
            ),
            "auto_writeback_enabled": bool(
                getattr(self.settings.closed_loop, "qaoateam_deeploop_auto_writeback_enabled", True)
            ),
            "max_rollbacks": int(getattr(self.settings.closed_loop, "qaoateam_deeploop_max_rollbacks", 2) or 2),
            "consistency_min": self._cl_float("qaoateam_deeploop_consistency_min", 0.0),
        }

    def retrieve_team_capsules_for_qaoateam(
        self,
        *,
        problem_type: str,
    ...
    def retrieve_role_ecaps_for_qaoateam(
        self,
        *,
        problem_type: str,
        participants: list[str],
        ...
        for role in participants:
            ...
            for cap in base:
                ...
                if r.replace("qaoateam-", "").replace("-", " ") in txt or r.lower() in txt:
                    hit = cap
                    break
    ...
    def deeploop_convergence_decision(
        ...
        *,
        ...
        from ..qaoa_learning.ops_observability import emit_ops_event

        cfg = self.get_qaoateam_deeploop_config()
    ...
    def deeploop_convergence_decision_with_alerts(
        ...
        *,
        ...
        When ``qaoateam_deeploop_consistency_min`` > 0 and the dashboard metric
        ...
        min_consistency = self._cl_float("qaoateam_deeploop_consistency_min", 0.0)
        ...
        if min_consistency > 0.0 and cc >= min_consistency:
            ...
            out = {
                ...
                "thresholds": {
                    ...
                    "convergence_rounds": rounds,
                    "handoff_target": target_handoff,
                    "qaoateam_deeploop_consistency_min": min_consistency,
    ...
    def record_qaoateam_iteration_feedback(
        self,
        *,
        tecap_id: str,
        iteration: int,
    ...
    def writeback_tecap_from_qaoateam(
        self,
        *,
        tecap_id: str,
    ...
    def writeback_role_ecap_from_qaoateam(
        self,
        *,
    ...
    def finalize_qaoateam_deeploop_writeback(
        self,
        *,
        tecap_id: str,
        iteration: int,
        ...
        if not bool(cfg.get("auto_writeback_enabled", True)):
            return {"skipped": True, "reason": "qaoateam_deeploop_auto_writeback_disabled"}
        row = self.record_qaoateam_iteration_feedback(
            tecap_id=tecap_id,
            iteration=iteration,
            iteration_goal=iteration_goal,
            role_handoff_result=role_handoff_result,
        ...
        tecap_wb = self.writeback_tecap_from_qaoateam(
            tecap_id=tecap_id,
        ...
        role_wb = self.writeback_role_ecap_from_qaoateam(
    ...
    def finalize_qaoateam_deeploop_from_output(
        self,
        *,
        tecap_id: str,
        role_ecap_map: dict[str, str],
        ...
        return self.finalize_qaoateam_deeploop_writeback(
            tecap_id=tecap_id,
    ...
    def experience_feedback(self, args: ExperienceFeedbackArgs) -> str:
        ...
        try:
            from ..qaoa_learning.ops_observability import build_long_term_metrics, emit_ops_event
    ...
    def create_team_experience(self, args: TeamExperienceCreateArgs) -> str:
        ...
        participant_rows = [
            TeamParticipant(
                agent_id=p,
                agent_role=p.replace("qaoateam-", "").replace("-", " "),
                model_profile="",
                responsibility="",
            )

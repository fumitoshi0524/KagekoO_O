...
Parity with ClawCode -- same classes: BaseTool, ToolCall, ToolContext, ToolInfo,
ToolResponse, ToolError, ToolPermissionError, ToolExecutionError.
"""
...
class ToolContext:
    ...
    def __init__(
        ...
        Args:
            ...
            iteration_budget: When set (e.g. Kageko mode), nested Agent runs share this cap.
        """

...
Parity with ClawCode -- same WriteTool, EditTool, PatchTool, FetchTool,
DiagnosticsTool, MCPTool, SourcegraphTool, AgentTool imports,
HunkLine, Hunk, FilePatch, PatchParseError, PatchApplyError,
and all create_*_tool factory functions.
"""

...
class ToolSpec:
    ...
    category: str = ""  # UniToolCall functional category
    domain: str = ""  # UniToolCall application domain
...
class ToolRegistry:
    ...
    def register(
        ...
        *,
        ...
        if self._frozen:
            raise RuntimeError("Tool registry is frozen. Tool changes are only allowed in code/training setup.")
